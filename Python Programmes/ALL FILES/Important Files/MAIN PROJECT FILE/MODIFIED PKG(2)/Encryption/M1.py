...
def Disp(o,s=''):
    ...
    j=['Click to copy','Click to copy','Click to exit','Click to exit','Click to exit','Click to exit','Click to exit','Click to exit','Click to exit','Click to exit','Click to exit','Click to exit']
    def des():
        n=o
        if n==0 or n==1:
            pyperclip.copy(s)
