...
def main(dec=None):
    def encry():
        ...
        b4=Button(text='?',font=('Calibri',10,'bold'),command=show_help,bg='yellow',fg='black',activebackground='yellow')
        b4.place(x=567,y=10)
    ...
    b9=Button(text='?',font=('Calibri',10,'bold'),command=show_help,bg='#040720',fg='white',activebackground='yellow')
    change_on_hover(b9,'yellow','#040720')
    b9.place(x=565,y=5)
