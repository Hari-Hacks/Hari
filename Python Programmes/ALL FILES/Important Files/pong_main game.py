...
def main():
    ...
    background_surface=pygame.image.load('C:/Users/Balamurugan/Desktop/Hari/Python Programmes/ALL FILES/Hari/bg.jpg').convert()
    player_2_surf=pygame.image.load('C:/Users/Balamurugan/Desktop/Hari/Python Programmes/ALL FILES/Hari/player 2 win.jpg').convert()
    player_1_surf=pygame.image.load('C:/Users/Balamurugan/Desktop/Hari/Python Programmes/ALL FILES/Hari/player 1 win.jpg').convert()
    font = pygame.font.Font('C:/Users/Balamurugan/Desktop/Hari/Python Programmes/ALL FILES/Hari/digital-7 (italic).ttf', 90)
    intro_surf=pygame.image.load('C:/Users/Balamurugan/Desktop/Hari/Python Programmes/ALL FILES/Hari/start screen.jpg').convert()
